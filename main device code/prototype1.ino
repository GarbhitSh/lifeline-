...
void loop(){
  if (Firebase.ready() && signupOK && (millis() - sendDataPrevMillis > 15000 || sendDataPrevMillis == 0)){
    ...
    if (Firebase.RTDB.setFloat(&fbdo, "GASESS/acetone", aC)){
  ...
  h2S=cosensorValue;
      if (Firebase.RTDB.setFloat(&fbdo, "GASESS/H2S", h2S)){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
  ...
  nH4=ppmAmmonia; 
    if (Firebase.RTDB.setFloat(&fbdo, "GASESS/nH4",nH4)){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
  ...
  Serial.println(ppmH2);
    if (Firebase.RTDB.setFloat(&fbdo, "GASESS/ppmH2",ppmH2)){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
  ...
  Serial.println(ppmLPG);
    if (Firebase.RTDB.setFloat(&fbdo, "GASESS/ppmLPG",ppmLPG)){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
  ...
  cH4=ppmCH4;
      if (Firebase.RTDB.setFloat(&fbdo, "GASESS/cH4",cH4)){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
  ...
  cO=ppmCO;
        if (Firebase.RTDB.setFloat(&fbdo, "GASESS/cO",cO)){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
